...
Calibration fit and forecasting are evaluated separately. One-step-ahead performance is summarized by
\begin{equation}
R^2_{OOS,m\mid b}=1-\frac{\sum e_{m,t,j}^2}{\sum e_{b,t,j}^2},
\label{eq:oos_r2}
\end{equation}
against both a node-specific expanding mean and the previous-day IV surface. This design prevents the lowest in-sample IV error from being interpreted automatically as predictive dominance.
