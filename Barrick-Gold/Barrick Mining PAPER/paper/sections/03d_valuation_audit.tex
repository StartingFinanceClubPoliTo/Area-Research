...
{\centering
  ...
  \captionof*{figure}{\textbf{Figure~\ref{fig:terminal_value_mechanics} (continued).} Present-value terminal share on positive-EV paths. Medians are 77.81\% for Black--Scholes, 79.12\% for Heston, 74.68\% for Bates and 78.06\% for Full Bates--Hawkes; bars show the P10--P90 range.}
\par}
\end{minipage}
