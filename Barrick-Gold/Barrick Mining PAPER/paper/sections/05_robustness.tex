...
{\centering
  \includegraphics[width=0.98\columnwidth]{figures/online_oos_r2_by_benchmark.png}
  \captionof{figure}{Dense-only rolling evidence on 30 forecast origins and 4,667 common target observations. Full Bates--Hawkes has the lowest date-equal IV RMSE. Positive $R^2_{OOS}$ denotes improvement over the stated benchmark.}
  \label{fig:oos_r2}
\par}
...
{\centering
  \includegraphics[width=0.98\columnwidth]{figures/online_welch_goyal_cumulative.png}
