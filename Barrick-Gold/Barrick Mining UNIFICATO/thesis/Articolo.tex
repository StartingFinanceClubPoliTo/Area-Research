...
\date{Working draft --- 28 August 2026}
...
\input{chapters/03-team-study-synthesis}
\input{chapters/02-gold-regimes-debasement}
\input{chapters/03-company-perimeter}
\input{chapters/03-data-and-design}
\input{chapters/03-current-lse-diagnostics}
...
\input{chapters/10-operations-ebitda}
\input{chapters/11-dcf}
\input{chapters/12-unified-experiment}
\input{chapters/14-discussion-conclusion}
