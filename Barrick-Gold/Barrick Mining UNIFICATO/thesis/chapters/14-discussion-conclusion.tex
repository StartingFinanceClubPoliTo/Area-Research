...
four-model path simulation and a 124-transition one-step-ahead comparison. Its
...
USD~23.99 and USD~39.48 per share, below the completed USD~47.27 close. The
close nevertheless remains inside every broad distribution, with 33.89--40.06\%
of simulated values above it. Full Bates--Hawkes is the primary current-fit
structural scenario and gives a median of USD~34.94, while Chapter~9 shows why
this designation is not a claim of predictive dominance. The shared direction
...
Barrick close and current surface audit are also asynchronous.
...
current cross-section favours the Full Bates--Hawkes fit, but its branching
ratio reaches the imposed 0.02 lower bound and the chronological test does not
establish universal forecast superiority. Parameter pressure,
