...
class VolterraProcess:
    ...
    @cached_property
    def induced_covariance(self) -> np.ndarray:
        """Discrete covariance generated by the causal kernel and Brownian shocks."""
        return self.grid.dt * (self.kernel @ self.kernel.T)
